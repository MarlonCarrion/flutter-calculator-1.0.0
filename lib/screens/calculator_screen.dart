import 'package:calculadora/block/calculator/calculator_bloc.dart';
            ...
            Row(
              ...
              children: [
                ...
                CalculatorButton(
                  text: 'del',
                  bgColor: Color(0xffA5A5A5),
                  onPressed: () => calculatorBloc.add(Del()),
                ),
                CalculatorButton(
                  text: '/',
                  bgColor: Color(0xffF0A23B),
                  onPressed: () => calculatorBloc.add(ChangeOperator('/')),
                ),
              ],
            ),
            Row(
              ...
              children: [
                ...
                CalculatorButton(
                  text: 'X',
                  bgColor: Color(0xffF0A23B),
                  onPressed: () => calculatorBloc.add(ChangeOperator('x')),
                ),
              ],
            ),
            Row(
